...
import org.usfirst.frc3793.CTRobot.subsystems.*;
...
public class Robot extends IterativeRobot {
    ...
    public static PIDPulley pulley;
 //   public static GrabberSonar grabberSonar;
  ...
  //      pIDPulley = new PIDPulley();

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    	pulley = new PIDPulley();
        //grabberSonar = new GrabberSonar();
