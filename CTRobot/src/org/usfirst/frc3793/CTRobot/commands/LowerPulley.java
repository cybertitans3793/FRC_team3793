 ...
 *
 */
public class  LowerPulley extends PIDCommand {

    public LowerPulley() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("LowerPulley", 1.0, 0.0, 0.0, 0.02);
...
//        requires(Robot.pIDPulley);
 ...
 //       requires(Robot.pulley);
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.pIDPulleyPulleySonar.pidGet();
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.pIDPulleyPulleyMotor.pidWrite(output);
