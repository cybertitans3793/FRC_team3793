 ...
 *
 */
public class  AutoMoveReverse extends PIDCommand {

    public AutoMoveReverse(double dist) {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("AutoMoveReverse", 4.0, 0.0, 0.0, 0.02);
...
//        return RobotMap.driveTrainQuadratureEncoderLeft.pidGet();
    	...
    	return (RobotMap.driveTrainQuadratureEncoderLeft.pidGet() + 
    			RobotMap.driveTrainQuadratureEncoderRight.pidGet())/2.0;
    }
...
//        RobotMap.driveTrainWheelR.pidWrite(output);
    ...
    protected void execute() {
    	System.out.println("Left Enc " + RobotMap.driveTrainQuadratureEncoderLeft.getDistance()
    			+ " Right Enc " + RobotMap.driveTrainQuadratureEncoderRight.getDistance());
    }
