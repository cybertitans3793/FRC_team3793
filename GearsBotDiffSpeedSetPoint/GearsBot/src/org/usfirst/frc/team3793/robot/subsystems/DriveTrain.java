...
public class DriveTrain extends Subsystem {
	...
	public DriveTrain() {
		...
		System.out.println("After drivestraight");
		...
		left_encoder.setPIDSourceParameter(PIDSourceParameter.kRate);
		right_encoder.setPIDSourceParameter(PIDSourceParameter.kRate);
	...
	public void drive(double left) {
		double thr = (Robot.oi.getThrottleSlider()-50.0)/50.0;
